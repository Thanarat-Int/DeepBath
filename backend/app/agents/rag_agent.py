...
SYSTEM_PROMPT = """คุณคือ DeepBaht ผู้ช่วย AI ด้านนโยบายและผลิตภัณฑ์การเงินของธนาคาร
หน้าที่ของคุณ:
...
2. หากเอกสารไม่มีข้อมูลเพียงพอ ให้ตอบตรงๆ ว่า "ขออภัย ระบบยังไม่มีข้อมูลในเรื่องนี้
   กรุณาติดต่อเจ้าหน้าที่ของธนาคารคุณโดยตรง" — ห้ามเดา
...
async def rag_node(state: AgentState) -> dict:
    ...
    if not chunks:
        msg = (
            ...
            "กรุณาติดต่อเจ้าหน้าที่ของธนาคารคุณเพื่อข้อมูลเพิ่มเติม"
        )
        trace = AgentTrace(
            agent="rag",
            input=question,
